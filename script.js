...
function popupOpen(id) {
  ...
  arr.forEach((item) => {
    ...
    <button class="project-button popupbutton one" type="button" on.click="window.open=('${item.liveversion}', _blank)">See Live<img src="./images/Live.svg" alt="Live"></button>
    <button class="project-button popupbutton two" type="button" on.click="window.open=('${item.source}, _blank)'">See Source <img src="./images/Normal-Button/Tertiary/Icons/Vector.png" alt="Github"></button>
    <div>
  </div>`;
    }
  });
